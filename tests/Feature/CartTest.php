...
describe('Cart Page', function () {
    ...
    it('displays cart with items', function () {
        $product = createTestProduct(['name' => 'Elf Bar', 'price' => 15.00]);
    ...
    it('only shows active products in cart', function () {
        $active = createTestProduct(['name' => 'Active Product', 'is_active' => true]);
        $inactive = createTestProduct(['name' => 'Inactive Product', 'is_active' => false]);
...
describe('Remove from Cart', function () {
    ...
    it('keeps other products when removing one', function () {
        $product1 = createTestProduct(['name' => 'Product 1']);
        $product2 = createTestProduct(['name' => 'Product 2']);
        session(['cart' => [
            $product1->id => 2,
            $product2->id => 3,
        ]]);
...
describe('Cart Totals', function () {
    ...
    it('calculates subtotal correctly', function () {
        $product1 = createTestProduct(['price' => 10.00]);
        $product2 = createTestProduct(['price' => 25.00]);
        session(['cart' => [
            $product1->id => 2,  // 20.00
            $product2->id => 1,  // 25.00
        ]]);
